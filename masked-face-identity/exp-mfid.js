...
timeline.push({
  ...
  url: 'https://ssmvl.github.io/2023/masked-face-identity/consent-ext.html',
  cont_btn: 'accept',
  check_fn: _ => true,
...
timeline.push({
  ...
  timeline: [
    { stimulus:
        ...
        and/or the Space bar. Please place your<br>
        fingers on J, K, L keys and press the <span class="resp-key">J</span> key.</p>`,
      choices: ['j'] },
